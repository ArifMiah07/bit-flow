...
export default function HeroSection() {
  return (
    <section className=" flex flex-col lg:flex-row items-center justify-center w-full h-full py-6 md:py-12 lg:py-24 px-4 lg:px-8 bg-[#f8f9ff] text-white">
      {/* hero text */}
      <div className=" slide-in-left w-full lg:w-1/2 flex flex-col gap-6 p-4 justify-center ">
      ...
      {/* hero image */}
      <div className="slide-in-right w-full lg:w-1/2 p-4 flex items-center justify-center">
        <img
